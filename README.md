...
As a user of Healthcare API Led Connectivity Web Portal I want a microservice to act as a process API to provide services to the experience layer of the architecture. 
This API provides operations for managing of appointments.

EHR Appointments Process API is part of the Healthcare Templates Solution and uses the standardized FHIR structures [version 1.0.2 DSTU2](https://www.hl7.org/FHIR/DSTU2/index.html).
